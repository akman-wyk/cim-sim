...
std::vector<uint8_t> MemorySocket::readData(const cimsim::InstructionPayload &ins, int address_byte, int size_byte) {
...
void MemorySocket::writeData(const cimsim::InstructionPayload &ins, int address_byte, int size_byte,
